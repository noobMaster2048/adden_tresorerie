<template>
    <div class="container mx-auto">
        <vs-card class="mb-8">
            <h1 class="font-bold">
                <inertia-link :href="route('plans')" class="text-yellow-400 hover:text-yellow-500">
                    plans comptables
                </inertia-link>
                <span class="font-medium text-yellow-500">/</span>
                <span>création</span>
            </h1>
        </vs-card>
        <div class="vx-row">
                ...
                <vs-card>
                    ...
                    <div>
                        ...
                        <div class="vx-row pb-6">
                            ...
                            <div class="vx-col w-full sm:w-5/6">
                                <vs-input class="w-full sm:w-3/5" v-model="form.libelle" :danger="checkLibelle" danger-text="Le libellé est obligatoire" />
                            </div>
                        </div>
                    </div>
                    <div slot="footer">
                        <div class="flex justify-end items-center">
                            <vs-button class="mx-2" :disabled="sending" color="warning" icon="save" @click="save">Enregistrer</vs-button>
                            <vs-button class="mx-2" color="dark" icon="save" @click="$inertia.replace(route('plans'))">Annuler</vs-button>
                        </div>
                    </div>
                </vs-card>
            </div>
       ...
       metaInfo: {
        ...
        data() {
           return {
               sending: false,
               form: {
                   libelle: this.plan.libelle,
                   compte: this.plan.num_compte,
               }
           }
        },
        methods: {
