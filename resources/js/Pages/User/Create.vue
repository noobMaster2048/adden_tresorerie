                ...
                <vs-card>
                    ...
                    <div>
                        ...
                        <div class="vx-row pb-6">
                            ...
                            <div class="vx-col w-full sm:w-5/6">
                                <vs-input v-model="form.password" class="w-full sm:w-3/5" :danger="checkPassword" danger-text="le mot de passe est obligatoire"/>
                            </div>
                        </div>
                        <div class="vx-row pb-6">
                            <div class="vx-col w-full sm:w-1/6">
    ...
    export default {
       metaInfo: {title: 'Formulaire utilisateur'},
        ...
        methods: {
           save() {
               this.sending = true;
                this.$inertia.post(this.route('user.store'), this.form).then(() => {
                    this.sending = false;
                })
           }
        },
        computed: {
           checkLogin() {
            ...
            checkPassword() {
               return this.$page.errors.password ? true : false;
           },
            checkNom() {
