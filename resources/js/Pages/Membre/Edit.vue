    ...
    <div class="container mx-auto">
        <vs-card class="mb-8">
            <h1 class="font-bold">
                ...
                <span class="font-medium text-indigo-400">/</span>
                <span>{{form.nom}} {{form.prenom}}</span>
            </h1>
        </vs-card>
        <div class="vx-row">
            <div class="vx-col w-full">
                <vs-card >
                    ...
                    <div>
                        ...
                        <div class="vx-row pb-6">
                            <div class="vx-col w-full sm:w-1/6">
                                <span class="text-color-base text-base font-medium capitalize">type de membre</span>
                            </div>
                            <div class="vx-col w-full sm:w-5/6">
                                <vs-select class="w-full sm:w-3/5" v-model="form.type_membre" autocomplete>
                                    <vs-select-item v-for="item in type_membres" :key="item.cle" :text="item.valeur" :value="item.cle"></vs-select-item>
                                </vs-select>
                            </div>
                        </div>
                        ...
                        <div class="vx-row pb-6" v-if="form.type_membre == 'phys'">
                            <div class="vx-col w-full sm:w-1/6">
                                <span class="text-color-base text-base font-medium capitalize">date de naissance</span>
                            </div>
                            <div class="vx-col w-full sm:w-5/6">
                        ...
                        <div class="vx-row pb-6" v-if="form.type_membre == 'phys'">
                            <div class="vx-col w-full sm:w-1/6">
                                <span class="text-color-base text-base font-medium capitalize">n° de carte d'identité</span>
                            </div>
                            <div class="vx-col w-full sm:w-5/6">
                        ...
                        <div class="vx-row pb-6">
                            <div class="vx-col w-full sm:w-1/6">
                                <span class="text-color-base text-base font-medium capitalize">n° de téléphone</span>
                            </div>
                            <div class="vx-col w-full sm:w-5/6">
        ...
        data() {
            return {
                ...
                form: {
                    ...
                    date_naissance: this.membre.date_naissance,
                    cni: this.membre.cni,
                    civilite: this.membre.civilite,
                    telephone: this.membre.telephone,
                    type_membre: this.membre.type_membre,
                }
            }
        },
        methods: {
            save() {
                this.sending = true;
                this.$inertia.put(this.route('membre.edit', this.membre.id), this.form).then(() => {
                    this.sending = false;
                })
            }
        }
