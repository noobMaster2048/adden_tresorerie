       ...
       layout: Layout,
        ...
        data() {
           return {
               sending: false,
               form: {
                   date_cotisation: this.cotisation.date_cotisation,
                   libelle: this.cotisation.libelle,
                   montant: this.cotisation.montant,
                   type_cotisation: this.cotisation.type_cotisation,
                   periode: this.cotisation.periode,
               }
           }
        },
        methods: {
           save() {
               this.sending = true;
               this.$inertia.put(this.route('cotisation.update', this.cotisation.id), this.form).then(() => {this.sending = false});
           }
        },
        computed: {
            checkLibelle() {
